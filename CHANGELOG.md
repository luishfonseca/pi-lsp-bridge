...
- 234c92c: Add external file detection with `externalPatterns` config and `includeExternal` tool parameter
...
- 234c92c: Refactor into modular `tools/` directory and add 8 new LSP tools
